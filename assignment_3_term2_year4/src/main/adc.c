...
Заметки: Инициализация и настройка 0 и 1 каналов ADC1
*******************************************************************************************************/
#include "adc.h"
...
void adc_init(void)
{
    ...
    gpioInitStructure.GPIO_Pin = adc_pin_0 | adc_pin_1;
